...
import { CheckIcon, CreditCard, Smartphone, AlertCircle, Wallet, Loader2 } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { getCurrentUser } from "@/services/auth.service";
import { processDocumentPayment } from "@/services/document.service";
...
export const EnhancedPaymentModal = ({
  ...
  const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<"momo" | "zalopay" | "balance">("balance");
  ...
  const handlePayment = async () => {
    ...
    try {
      if (selectedPaymentMethod === "balance") {
        ...
        const result = await processDocumentPayment(docId, "balance");
      ...
      <div className="py-4 flex flex-col items-center">
        <div className="mb-4 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Sử dụng ứng dụng {selectedPaymentMethod === "momo" ? "MoMo" : "ZaloPay"} để quét mã
          </p>
        </div>
            ...
            <div className="flex justify-between">
              ...
              <dd className="text-sm font-medium">
                {selectedPaymentMethod === "balance" ? "Số dư tài khoản" : 
                 selectedPaymentMethod === "momo" ? "MoMo" : "ZaloPay"}
              </dd>
            </div>
            <div className="flex justify-between">
        ...
        {paymentStep === "method" && (
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={isProcessing || (!isFree && insufficientFunds && selectedPaymentMethod === "balance")}
            >
