        ...
        if (fileType.includes('pdf')) {
            return (
                <object
                    ...
                    onError={handlePreviewError}
                >
                    <p>Trình duyệt của bạn không hỗ trợ xem trước PDF</p>
                </object>
            );
        } else if (fileType.includes('image')) {
            return (
            ...
            return (
                <div className="w-full h-[600px] bg-white p-4 overflow-auto border rounded">
                    <iframe
                        src={previewUrl}
                        className="w-full h-full border-0"
            ...
            return (
                <div className="flex items-center justify-center h-[600px] bg-gray-50">
                    <div className="text-center">
                        <p className="text-gray-500 mb-2">Không hỗ trợ xem trước loại file này</p>
                        <p className="text-sm text-gray-400">{document.file_type}</p>
                    </div>
                </div>
            );
        }
